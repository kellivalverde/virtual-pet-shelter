...
//arrange 
	...
	public void setUp() { // method that sets up project so you can have objects for your test
		...
		pet1 = new VirtualPet("MeiLing", "the big, fat, fluffy cat", 0, 0, 0, 2);
		pet2 = new VirtualPet("Rigby", "the skinny sleek black cat", 3, 0, 0, 0);
		pet3 = new VirtualPet("Oliver", "the scruffy old gray cat", 0, 0, 1, 0);
	}
